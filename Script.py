...
• /delall - <code>ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ᴡʜᴏʟᴇ ꜰɪʟᴛᴇʀꜱ ɪɴ ᴀ ᴄʜᴀᴛ (ᴄʜᴀᴛ ᴏᴡɴᴇʀ ᴏɴʟʏ)</code>"""
    FILETOLINK = """Fᴏʀᴡᴀʀᴅ ᴀɴʏ ꜰɪʟᴇ ꜰʀᴏᴍ `ᴍᴇ´ ᴏʀ @MoViE_2022_NT_Bot ᴏʀ @MrMoviez_Bot

To; @Ms_FiLe2LINk_bOt

ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ ᴀ ᴡᴀᴛᴄʜᴇᴀʙʟᴇ ᴀɴᴅ ᴅᴏᴡɴʟᴏᴀᴅᴀʙʟᴇ ʟɪɴᴋ ꜰᴀꜱᴛʟʏ.....😜😜😜😜😜😜😜"""
...
✧ Sʜᴏʀᴛ Lɪɴᴋ
<b>ɴᴏᴛᴇ:</b>
1. ᴀᴅᴅ ᴍᴇ ᴛᴏ yᴏᴜʀ ɢʀᴏᴜᴩ ᴀɴᴅ /connect ᴛʜᴇɴ ᴏɴʟy ᴛʜᴇ /settings ᴡɪʟʟ ᴡᴏʀᴋ
2. ᴛᴜʀɴɪɴɢ ᴏꜰꜰ <b>'✧ Aᴜᴛᴏ-Dᴇʟᴇᴛᴇ'</b> ɪꜱ ʟɪᴋᴇ ᴛᴀᴋɪɴɢ ʀɪꜱᴋ, ᴄᴀɴ ᴄᴏᴢ ʀᴇᴄᴇɪᴠɪɴɢ ᴄᴏᴩy ʀɪɢʜᴛ ꜱᴛʀɪᴋᴇ. ꜱᴏ, ʙᴇ ᴄᴀᴜᴛɪᴏɴ."""
...
<b>ɴᴏᴛᴇ: Fɪʟᴇ Syᴅᴇx/Iɴᴅᴇx</b>
1. ᴍᴀᴋᴇ ᴍᴇ ᴛʜᴇ ᴀᴅᴍɪɴ ᴏꜰ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ɪꜰ ɪᴛ'ꜱ ᴘʀɪᴠᴀᴛᴇ.
2. ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛʜᴀᴛ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ᴅᴏᴇꜱ ɴᴏᴛ ᴄᴏɴᴛᴀɪɴꜱ ᴄᴀᴍʀɪᴘꜱ, ᴘᴏ*ɴ ᴀɴᴅ ꜰᴀᴋᴇ ꜰɪʟᴇꜱ.
...
ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀ'ꜱ..., Iꜰ Yᴏᴜ Δʀᴇ Jᴜꜱᴛ Tᴇꜱᴛɪɴɢ, Tʜᴇɴ Kɴᴏᴡ»»»»» Tʜᴀᴛ Iᴛ Wɪʟʟ W𝙾ʀᴋ Pʀᴏᴩᴇʀʟy ☺️. Fɾᴏᴍ Aʙᴏᴠᴇ IMBD Yᴏᴜ ᴄAɴ Cᴏᴩy Tᴇxᴛ, 😁"""

    OLD_ALRT_TXT = """ʜᴇʏ {},
ʏᴏᴜ ᴀʀᴇ ᴜꜱɪɴɢ ᴏɴᴇ ᴏꜰ ᴍʏ ᴏʟᴅ ᴍᴇꜱꜱᴀɢᴇꜱ, 
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ. My Mᴇᴍᴏʀy Iꜱ WΞᴀᴋ ( tʜᴇʀᴇ mᴀɴy Pᴏᴩɪʟ Kɴᴏᴡ (10 + 🤣) [ Chali🫣 💨] )"""

    CUDNT_FND = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ? Iꜰ yᴇꜱ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴀᴛ ʙᴜᴛᴛᴏɴ,ᴇʟꜱᴇ ᴄʜᴇᴄᴋ ᴡʜᴇᴛʜᴇʀ ɪᴛ ɪꜱ ʀᴇʟᴀᴇꜱᴇᴅ ᴏʀ ɴᴏᴛ ( Nᴏᴛ ꜱᴀyɪɴɢ ɪꜱ ᴛʜᴀᴛ ꜰɪʟᴍ ᴏʀ ꜱᴇʀɪᴇꜱ, ʜᴏᴩᴇ yᴏᴜ ᴜɴᴅᴇʀꜱᴛᴀɴᴅ ɪᴛ....)......


"""

    I_CUDNT = """<b>sᴏʀʀʏ ɴᴏ ꜰɪʟᴇs ᴡᴇʀᴇ ꜰᴏᴜɴᴅ ꜰᴏʀ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ {} 😕. ᴅᴏɴ'ᴛ ᴡᴏʀʀy ɪᴛ ʜᴀᴠᴇ ʙᴇᴇɴ ɴᴏᴛɪꜰɪᴇᴅ ᴛᴏ ᴏᴜʀ @ADMIN 🫥.
Bᴇꜰᴏʀᴇ ᴛʜᴀᴛ ᴄʜᴇᴄᴋ ᴏɴᴇ ᴍᴏʀΞ ᴛɪᴍᴇ ;
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./) Aɴᴅ Sᴩᴇᴄɪᴀʟ MФᴅɪꜰɪᴄΔᴛᴏɪɴ Tᴏ Lᴇᴛᴛᴇʀ. 🫠</b>"""

    I_CUD_NT = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""

    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ Syᴅ-ʙᴀꜱᴇ..., ᴅᴏɴ'ᴛ ɴᴇᴇᴅ ᴛᴏ ꜰᴇᴇʟ ꜱᴀᴅ, ɪꜰ ᴛʜᴇ ᴍᴏᴠɪᴇ ɪꜱ ʀᴇʟᴇᴀꜱᴇᴅ ᴏɴ ᴏᴛᴛ ᴩʟᴀᴛꜰᴏʀᴍ, yᴏᴜ ᴡ'ʟʟ ɢᴇᴛ ᴡᴇ ʜᴀᴠᴇ ɴᴏᴛɪꜰɪᴇᴅ ᴛᴏ @ADMIN """

    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ Mᴏᴠɪᴇ Iɴ My Syᴅ-ʙᴀsᴇ... Pʟᴢ ᴡᴀɪᴛ ↻↻ """

    MELCOW_ENG = """<b>Hᴇʟʟᴏ {} 🤗, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ 0ᴜʀ {} Gʀᴏᴜᴘ . Tʜɪꜱ ɪꜱ ᴀ Pᴏᴡᴇʀꜰᴜʟʟ ɢʀᴏUᴩ, Wɪᴛʜ Uɴʟɪᴍɪᴛᴇᴅ Mᴏᴠɪᴇꜱ🫠 [ 20+ ʟᴀᴋʜ ]. Hᴏᴩɪɴɢ Yᴏᴜ Wᴏᴜʟᴅ Lɪᴋᴇ ᴛʜᴇ Gʀᴏᴜᴩ. 😇</b>"""

    OWNER_INFO = """
<b>╭━━━━❰ OᴡɴΞʀ DᴇᴛΔɪʟꜱ ⍟ ❱━➣
┣⪼ ғᴜʟʟ ɴΔᴍᴇ : 𝕸𝖗 Sy∂ ( 🥰 ɢᴜΞꜱѕ 😇)
┣⪼ DᴏБ : ɢᴜᴇꜱꜱ ᴀɢΔɪɴ 🤭
┣⪼ ʊꜱᴇʀ ɴαᴍΞ : @Syd_Xyz
...
ᴀꜰᴛᴇʀ 10-ᴍɪɴ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ
ɪꜰ ᴜ ᴅᴏɴᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ꜰɪʟᴇ, ʟᴏᴏᴋ @ ɴᴇxᴛ ᴘᴀɢᴇ
Cʟɪᴄᴋ ᴏɴ ʟᴀɴɢ-ɢᴇꜱ ᴛᴏ ɢᴇᴛ ꜰɪʟᴇꜱ ᴏꜰ ᴩᴀʀᴛɪᴄᴜʟᴀʀ ʟᴀɴɢ.
TʜΔɴᴋ U 4 ᴜꜱɪɴG ᴍє.🤗"""
...
Jᴜꜱᴛ ᴛyᴩᴇ ᴀɴᴅ Sᴇɴᴅ ᴛʜᴇ Cᴏʀʀᴇᴄᴛ Sᴩᴇʟʟɪɴɢ ᴏꜰ ᴛʜᴀᴛ ᴍᴏᴠɪᴇ..
ᴇxᴀᴍᴘʟᴇ : Lᴇᴏ 2023
Uncharted❗️ ᴇᴛᴄ.. ❗️
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ :(!,./), Aɴᴅ Sᴩᴇᴄɪᴀʟ Mᴏᴅɪꜰɪᴄᴀᴛɪᴏɴ ᴛᴏ Lᴇᴛᴛᴇʀꜱ.. 😋 """
    ...
    SINFO = """
»»»»»»ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ««««««
Jᴜꜱᴛ ᴛyᴩᴇ ᴀɴᴅ Sᴇɴᴅ ᴛʜᴇ Cᴏʀʀᴇᴄᴛ Sᴩᴇʟʟɪɴɢ ᴏꜰ ᴛʜᴀᴛ Sᴇʀɪᴇꜱ..
...
🌟 Rating: <a href={url}/ratings>{rating}</a> / 10</b>"""
    ...
    ALL_FILTERS = """
<b>Hᴇʏ {}, Tʜᴇsᴇ ᴀʀᴇ ᴍʏ ᴛʜʀᴇᴇ ᴛʏᴘᴇs ᴏғ ғɪʟᴛᴇʀs. Rᴇᴀᴅ ᴄᴀʀᴇꜰᴜʟʟy ʙᴇꜰᴏʀᴇ ᴜꜱɪɴɢ ɪᴛ. 😁</b>"""
    
    GFILTER_TXT = """
<b>Wᴇʟᴄᴏᴍᴇ ᴛᴏ Gʟᴏʙᴀʟ Fɪʟᴛᴇʀs. Gʟᴏʙᴀʟ Fɪʟᴛᴇʀs ᴀʀᴇ ᴛʜᴇ ғɪʟᴛᴇʀs sᴇᴛ ʙʏ ʙᴏᴛ ᴀᴅᴍɪɴs ᴡʜɪᴄʜ ᴡɪʟʟ ᴡᴏʀᴋ ᴏɴ ᴀʟʟ ɢʀᴏᴜᴘs.</b>
    
Aᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs:
• /gfilter - <code>Tᴏ ᴄʀᴇᴀᴛᴇ ᴀ ɢʟᴏʙAʟ ғɪʟᴛᴇʀ.</code>
...
• /link - <code>Tᴏ ᴄʀᴇᴀᴛᴇ ᴀ sɪɴɢʟᴇ ғɪʟᴇ sᴛ0ʀᴇ ʟɪɴᴋ.</code>
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>v2.7.1 [ Syᴅ ]</code></b>"""
